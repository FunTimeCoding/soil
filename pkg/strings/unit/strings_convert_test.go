...
func TestAnyToSlice(t *testing.T) {
	...
	assert.Strings(
		t,
		[]string{"Alfa", "Bravo"},
		strings.AnyToSlice([]string{constant.UpperAlfa, constant.UpperBravo}),
	)
}
...
func TestMustToInteger(t *testing.T) {
	assert.Integer(t, 1, strings.MustToInteger(constant.One))
...
func TestToBoolean(t *testing.T) {
	assert.True(t, strings.ToBoolean(constant.BooleanTrue))
	assert.False(t, strings.ToBoolean(constant.BooleanFalse))
}
...
func TestToInteger(t *testing.T) {
	assert.Integer(t, 5, strings.ToInteger(constant.Five, 0))
...
func TestToLower(t *testing.T) {
	assert.Strings(
		t,
		[]string{"alfa", "bravo"},
		strings.ToLower([]string{constant.UpperAlfa, constant.UpperBravo}),
	)
}
...
func TestToMap(t *testing.T) {
	assert.Any(
		...
		strings.ToMap([]string{"A=a", "B=b"}, constant.Equals),
	)
}
