...
const (
	...
	TopLevelResponseModelContextKey  = "top_level_response_model_context"
	TopLevelResponseModelContextText = "response/ is top-level (should be convert/ or model_context/response/)"
	ConstantFileKey                  = "constant_file"
	ConstantFileText                 = "constant.go should be constant/ directory"
	ConstantDepthKey                 = "constant_depth"
	ConstantDepthText                = "constant/ outside pkg/<domain> or pkg/tool/<name>"
	ConstantNestedKey                = "constant_nested"
	ConstantNestedText               = "constant/ contains subpackages"
	...
	StrictMiddlewareText             = "NewStrictHandler without web.RecordingMiddleware"
	RawModelContextServerKey         = "raw_model_context_server"
	RawModelContextServerText        = "model_context/new.go calls NewMCPServer directly (use the mark server builder)"
	RootRouteKey                     = "root_route"
	ClientConstantKey                = "client_constant"
	...
	ResponseReferenceKey             = "response_reference"
	...
	UnresolvedToolNameKey            = "unresolved_tool_name"
	UnresolvedToolNameText           = "tool name not resolvable to a string"
	FileNotParseableKey              = "not_parseable"
	FileNotParseableText             = "file not parseable"
)
