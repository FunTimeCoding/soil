...
// NewGetRecentAlertsRequest constructs an http.Request for the GetRecentAlerts method
...
// NewGetTopAlertsRequest constructs an http.Request for the GetTopAlerts method
...
func (r GetAlertsResponse) GetJSON500() *ErrorResponse {
	return r.JSON500
}
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r GetRecentAlertsResponse) GetJSON200() *[]AlertsResponse {
	return r.JSON200
}

// GetJSON500 returns the response for an HTTP 500 `application/json` response
func (r GetRecentAlertsResponse) GetJSON500() *ErrorResponse {
	return r.JSON500
}

// GetBody returns the raw response body bytes
func (r GetRecentAlertsResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r GetRecentAlertsResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r GetTopAlertsResponse) GetJSON200() *[]TopAlertsResponse {
	return r.JSON200
}

// GetJSON500 returns the response for an HTTP 500 `application/json` response
func (r GetTopAlertsResponse) GetJSON500() *ErrorResponse {
	return r.JSON500
}

// GetBody returns the raw response body bytes
func (r GetTopAlertsResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r GetTopAlertsResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
