...
func (s *Server) Mount(m *http.ServeMux) {
	...
	m.HandleFunc("GET /palette/memories", s.paletteMemories)
	m.HandleFunc("GET /palette/memories/search", s.paletteMemoriesSearch)
	...
	m.HandleFunc("GET /relations", s.relationsPage)
