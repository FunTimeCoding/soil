...
func TestMoveConstant(t *testing.T) {
	d := testutil.PrepareTestPackage(t, "testdata/move-constant/src")
	s := testService()
	r, e := s.MoveSymbol(
		d,
		"example/pkg/target",
...
func TestMoveCrossPackage(t *testing.T) {
	d := testutil.PrepareTestPackage(t, "testdata/move-cross-package/src")
	s := testService()
	r, e := s.MoveSymbol(
		d,
		"example/pkg/target",
...
func TestMoveAlias(t *testing.T) {
	d := testutil.PrepareTestPackage(t, "testdata/move-alias/src")
	s := testService()
	r, e := s.MoveSymbol(
		d,
		"example/pkg/target",
...
func TestMoveCreateRefused(t *testing.T) {
	d := testutil.PrepareTestPackage(t, "testdata/move-create/src")
	s := testService()
	r, e := s.MoveSymbol(
		d,
		"example/pkg/target",
...
func TestMoveCollision(t *testing.T) {
	d := testutil.PrepareTestPackage(t, "testdata/move-collision/src")
	s := testService()
	r, e := s.MoveSymbol(
		d,
		"example/pkg/target",
...
func TestMoveCycle(t *testing.T) {
	d := testutil.PrepareTestPackage(t, "testdata/move-cycle/src")
	s := testService()
	r, e := s.MoveSymbol(
		d,
		"example/pkg/target",
...
func TestMoveGroup(t *testing.T) {
	d := testutil.PrepareTestPackage(t, "testdata/move-group/src")
	s := testService()
	r, e := s.MoveSymbol(
		d,
		"example/pkg/target",
...
func TestMoveFunction(t *testing.T) {
	d := testutil.PrepareTestPackage(t, "testdata/move-function/src")
	s := testService()
	r, e := s.MoveSymbol(
		d,
		"example/pkg/target",
