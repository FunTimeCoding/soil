...
func TestExtractType(t *testing.T) {
	d := testutil.PrepareTestPackage(t, "testdata/extract-basic/src")
	s := testService()
	r, e := s.ExtractType(
		d,
		"example/pkg/target",
...
func TestExtractTypeInternalStaysUnexported(t *testing.T) {
	d := testutil.PrepareTestPackage(t, "testdata/extract-internal/src")
	s := testService()
	r, e := s.ExtractType(
		d,
		"example/pkg/target",
...
func TestExtractTypeCollision(t *testing.T) {
	d := testutil.PrepareTestPackage(t, "testdata/extract-collision/src")
	s := testService()
	r, e := s.ExtractType(
		d,
		"example/pkg/target",
...
func TestExtractTypeDependency(t *testing.T) {
	d := testutil.PrepareTestPackage(t, "testdata/extract-dependency/src")
	s := testService()
	r, e := s.ExtractType(
		d,
		"example/pkg/target",
