...
type ClientInterface interface {
	...
	// PostEventWithBody performs a POST /api/events (the `PostEvent` operationId) request,
	...
	// PostEvent performs a POST /api/events (the `PostEvent` operationId) request.
	// Takes a body of the `application/json` content type.
	PostEvent(ctx context.Context, body PostEventJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetSummary performs a GET /api/summary (the `GetSummary` operationId) request.
...
// NewGetSummaryRequest constructs an http.Request for the GetSummary method
...
type ClientWithResponsesInterface interface {
	...
	// PostEventWithBodyWithResponse performs a POST /api/events (the `PostEvent` operationId) request,
	// with any type of body and a specified content type.
	//
	// Returns a wrapper object for the known response body format(s).
	...
	// PostEventWithResponse performs a POST /api/events (the `PostEvent` operationId) request.
	...
	// GetSummaryWithResponse performs a GET /api/summary (the `GetSummary` operationId) request.
	//
	// Returns a wrapper object for the known response body format(s).
...
func (r GetEventsResponse) GetJSON200() *[]EventEntry {
	return r.JSON200
}
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r PostEventResponse) GetJSON200() *EventResponse {
	return r.JSON200
}

// GetJSON500 returns the response for an HTTP 500 `application/json` response
func (r PostEventResponse) GetJSON500() *ErrorResponse {
	return r.JSON500
}
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r GetSummaryResponse) GetJSON200() *[]SummaryEntry {
	return r.JSON200
}

// GetJSON500 returns the response for an HTTP 500 `application/json` response
func (r GetSummaryResponse) GetJSON500() *ErrorResponse {
	return r.JSON500
}

// GetBody returns the raw response body bytes
func (r GetSummaryResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r GetSummaryResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
