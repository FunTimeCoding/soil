...
func Main(
	...
	o.AddCommand(getVirtualMachine(c))
	o.AddCommand(listInterfaces(c))
	o.AddCommand(listAddresses(c))
	o.AddCommand(listVirtualInterfaces(c))
	o.AddCommand(listVirtualAddresses(c))
	o.AddCommand(listVirtualDisks(c))
	o.AddCommand(createVirtualDisk(c))
	o.AddCommand(renameDevice(c))
	o.AddCommand(renameVirtualMachine(c))
	o.AddCommand(setDevicePrimaryAddress(c))
	o.AddCommand(setVirtualPrimaryAddress(c))
	o.AddCommand(updateDevice(c))
	o.AddCommand(updateVirtualMachine(c))
	o.AddCommand(listAddressRanges(c))
	o.AddCommand(createAddressRange(c))
	o.AddCommand(listLocations(c))
	o.AddCommand(createLocation(c))
	o.AddCommand(listPlatforms(c))
	o.AddCommand(createPlatform(c))
	o.AddCommand(listWirelessNetworks(c))
	o.AddCommand(createWirelessNetwork(c))
	...
	o.AddCommand(addDeviceJournalEntry(c))
	o.AddCommand(listDeviceJournalEntries(c))
	o.AddCommand(addVirtualJournalEntry(c))
	...
	o.AddCommand(setVirtualLabel(c))
	o.AddCommand(removeVirtualLabel(c))
	o.AddCommand(listVirtualLabels(c))
