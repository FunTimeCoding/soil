...
// NewPostGenerateRequestWithBody constructs an http.Request for the PostGenerate method, with any body, and a specified content type
...
func (r PostGenerateResponse) GetJSON200() *GenerateResponse {
	return r.JSON200
}

// GetJSON500 returns the response for an HTTP 500 `application/json` response
func (r PostGenerateResponse) GetJSON500() *ErrorResponse {
	return r.JSON500
}

// GetBody returns the raw response body bytes
func (r PostGenerateResponse) GetBody() []byte {
	return r.Body
}
...
func (r PostGenerateResponse) ContentType() string {
	if r.HTTPResponse != nil {
